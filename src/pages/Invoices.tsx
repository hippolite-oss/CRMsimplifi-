...
import {
    Search, Filter, FileText, Printer, Download, Eye,
    DollarSign, User, Calendar, Clock, CheckCircle, XCircle,
    PlusCircle, RefreshCw, TrendingUp, TrendingDown, MoreVertical,
    ChevronLeft, ChevronRight, ArrowUpDown, FileDigit, Receipt,
    Mail, Phone, Building, MapPin, Hash, Edit, Trash2,
    AlertCircle, ExternalLink, Copy, QrCode, Percent
} from 'lucide-react';
...
const Invoices = () => {
    ...
    const facturesMock = [
        {
            ...
            vendeur: 'Admin',
            articles: [
                { id: 1, nom: "Ordinateur Portable", quantite: 1, prixUnitaire: 350000, tva: 18, total: 350000 },
                { id: 2, nom: "Souris sans fil", quantite: 2, prixUnitaire: 25000, tva: 18, total: 50000 },
                { id: 3, nom: "Clavier mécanique", quantite: 1, prixUnitaire: 50000, tva: 18, total: 50000 }
            ],
        ...
        },
        {
            ...
            vendeur: 'Admin',
            articles: [
                { id: 4, nom: "Smartphone Android", quantite: 1, prixUnitaire: 299900, tva: 18, total: 299900 },
                { id: 5, nom: "Écouteurs Bluetooth", quantite: 1, prixUnitaire: 49900, tva: 18, total: 49900 }
            ],
            notes: "",
        ...
        },
        {
            ...
            vendeur: 'Vendeur1',
            articles: [
                { id: 6, nom: "Tablette Android", quantite: 1, prixUnitaire: 423729, tva: 18, total: 423729 }
            ],
        ...
        },
        {
            ...
            vendeur: 'Admin',
            articles: [
                { id: 7, nom: "Ordinateur Portable Pro", quantite: 2, prixUnitaire: 338983, tva: 18, total: 677966 }
            ],
        ...
        },
        {
            ...
            vendeur: 'Vendeur2',
            articles: [
                { id: 8, nom: "Écouteurs Pro", quantite: 5, prixUnitaire: 42373, tva: 18, total: 211864 }
            ],
        ...
        },
        {
            ...
            vendeur: 'Admin',
            articles: [
                { id: 9, nom: "Montre Connectée", quantite: 1, prixUnitaire: 169492, tva: 18, total: 169492 }
            ],
        ...
        },
        {
            ...
            vendeur: 'Vendeur1',
            articles: [
                { id: 10, nom: "Enceinte Portable", quantite: 1, prixUnitaire: 84746, tva: 18, total: 84746 }
            ],
        ...
        },
        {
            ...
            vendeur: 'Admin',
            articles: [
                { id: 11, nom: "Serveur Entreprise", quantite: 1, prixUnitaire: 762712, tva: 18, total: 762712 }
            ],
        ...
        },
        {
            ...
            vendeur: 'Vendeur2',
            articles: [
                { id: 12, nom: "Ordinateur Portable", quantite: 1, prixUnitaire: 338983, tva: 18, total: 338983 }
            ],
            notes: "",
            conditionsPaiement: "Comptant"
        },
        {
            ...
            vendeur: 'Admin',
            articles: [
                { id: 13, nom: "Tablette Pro", quantite: 1, prixUnitaire: 423729, tva: 18, total: 423729 }
            ],
    ...
    const clientsUniques = [...new Set(facturesMock.map(f => f.client.entreprise))];
    ...
    const calculerStats = (facturesList) => {
        ...
        const montantTotal = facturesList.reduce((sum, f) => sum + f.totalAPayer, 0);
    ...
    const facturesFiltrees = useMemo(() => {
            ...
            switch(filterDate) {
                ...
                case 'personnalise':
                    if (dateDebut && dateFin) {
                        filtered = filtered.filter(f => f.dateEmission >= dateDebut && f.dateEmission <= dateFin);
                    }
                    break;
            }
        }
        ...
        return filtered;
    }, [factures, search, filterStatut, filterClient, filterDate, dateDebut, dateFin, sortBy, sortOrder]);

    // Pagination
    const totalPages = Math.ceil(facturesFiltrees.length / itemsPerPage);
    const startIndex = (currentPage - 1) * itemsPerPage;
    const endIndex = startIndex + itemsPerPage;
    const facturesPagines = facturesFiltrees.slice(startIndex, endIndex);

    // Fonctions utilitaires
    const getStatutColor = (statut) => {
        switch(statut) {
            case 'payee':
                return { bg: 'bg-green-100', text: 'text-green-800', label: 'Payée', icon: <CheckCircle className="w-4 h-4" /> };
            case 'partiellement':
                return { bg: 'bg-yellow-100', text: 'text-yellow-800', label: 'Partiellement', icon: <Clock className="w-4 h-4" /> };
            case 'impayee':
                return { bg: 'bg-red-100', text: 'text-red-800', label: 'Impayée', icon: <XCircle className="w-4 h-4" /> };
            default:
                return { bg: 'bg-gray-100', text: 'text-gray-800', label: statut, icon: null };
        }
    };
    ...
    const calculateDaysLeft = (dateEcheance) => {
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">{stats.total} factures</p>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-lg shadow-sm border p-4">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900">{stats.montantTotal.toLocaleString()} F</p>
                            </div>
                    ...
                    <div className="bg-white rounded-lg shadow-sm border p-4">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900">{stats.impayees}</p>
                            </div>
                    ...
                    <div className="bg-white rounded-lg shadow-sm border p-4">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-gray-900">{stats.montantImpaye.toLocaleString()} F</p>
                            </div>
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 flex items-center justify-between">
                        <div>
                            <p className="font-medium text-blue-900">
                                {selectedFactures.length} facture{selectedFactures.length > 1 ? 's' : ''} sélectionnée{selectedFactures.length > 1 ? 's' : ''}
                            </p>
                        </div>
                        <div className="flex items-center gap-2">
                ...
                <div className="bg-white rounded-lg shadow-sm border overflow-hidden">
                            ...
                            <thead className="bg-gray-50">
                                <tr>
                                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                        <input
                                            type="checkbox"
                                            checked={selectedFactures.length === facturesPagines.length && facturesPagines.length > 0}
                                            ...
                                            <tr key={facture.id} className="hover:bg-gray-50">
                                                ...
                                                <td className="px-6 py-4">
                                                    ...
                                                    <div className="text-xs text-gray-500">
                                                        ...
                                                        {daysLeft !== null && (
                                                            <span className={`ml-2 ${isOverdue ? 'text-red-600' : daysLeft <= 3 ? 'text-yellow-600' : 'text-gray-500'}`}>
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="font-medium">{facture.client.entreprise}</div>
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className={`px-3 py-1 rounded-full text-xs font-medium flex items-center gap-1 ${statutInfo.bg} ${statutInfo.text}`}>
                                                        {statutInfo.icon}
                                                        {statutInfo.label}
                                                    </div>
                                                </td>
                    ...
                    <div className="px-6 py-4 border-t flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        <div className="text-sm text-gray-700">
                            Affichage de {startIndex + 1} à {Math.min(endIndex, facturesFiltrees.length)} sur {facturesFiltrees.length} factures
                        </div>
                        <div className="flex items-center gap-2">
                            <button
                    ...
                    <div className="bg-white rounded-lg shadow-lg max-w-6xl w-full max-h-[90vh] overflow-y-auto">
                        <div className="p-6">
                            <div className="flex items-center justify-between mb-6">
                                <div>
                                    <h2 className="text-2xl font-bold text-purple-600">{selectedFacture.numero}</h2>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                                ...
                                <div>
                                    ...
                                    <div className="bg-gray-50 p-4 rounded-lg">
                                        <p className="font-bold">{selectedFacture.client.entreprise}</p>
                                        <p className="text-gray-600">{selectedFacture.client.prenom} {selectedFacture.client.nom}</p>
                                        <p className="text-gray-600">{selectedFacture.client.adresse}</p>
                                        <p className="text-gray-600">Tél: {selectedFacture.client.telephone}</p>
                                        <p className="text-gray-600">Email: {selectedFacture.client.email}</p>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <span className={`px-2 py-1 rounded text-xs font-medium ${getStatutColor(selectedFacture.statut).bg} ${getStatutColor(selectedFacture.statut).text}`}>
                                ...
                                <table className="w-full">
                                    <thead className="bg-gray-100">
                                        <tr>
                                            ...
                                            <th className="px-4 py-3 text-right text-sm font-medium text-gray-700">Prix unitaire HT</th>
                                    ...
                                    <tbody>
                                        {selectedFacture.articles.map((article, index) => (
                                            <tr key={index} className="border-t">
                                                ...
                                                <td className="px-4 py-3 text-right">{article.prixUnitaire.toLocaleString()} F</td>
                                                <td className="px-4 py-3 text-right">{article.tva}%</td>
                                                <td className="px-4 py-3 text-right font-medium">{article.total.toLocaleString()} F</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <div className="bg-gray-50 p-4 rounded-lg">
                                        <p className="text-gray-700">{selectedFacture.conditionsPaiement}</p>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex justify-between">
                                            ...
                                            <span>{selectedFacture.montantHT.toLocaleString()} F</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-gray-600">TVA ({selectedFacture.tva}%):</span>
                                            <span>{selectedFacture.montantTVA.toLocaleString()} F</span>
                                        </div>
                                        {selectedFacture.fraisTransport > 0 && (
                                            <div className="flex justify-between">
                                                <span className="text-gray-600">Frais de transport:</span>
                                                <span>+ {selectedFacture.fraisTransport.toLocaleString()} F</span>
                                            </div>
                                        )}
                                        {selectedFacture.remise > 0 && (
                                            <div className="flex justify-between text-red-600">
                                                <span>Remise:</span>
                                                <span>- {selectedFacture.remise.toLocaleString()} F</span>
                                            </div>
                                        )}
                                        <div className="pt-3 border-t">
                                            <div className="flex justify-between text-lg font-bold">
                                                <span>Total TTC:</span>
                                                <span className="text-purple-600">{selectedFacture.totalAPayer.toLocaleString()} F</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-4 pt-4 border-t">
                                            ...
                                            {selectedFacture.modePaiement ? (
                                                <div className="space-y-2">
                                                    <div className="flex justify-between">
                                                        <span>Mode:</span>
                                                        <span>{getPaiementLabel(selectedFacture.modePaiement)}</span>
                                                    </div>
                                                    ...
                                                    {selectedFacture.datePaiement && (
                                                        <div className="flex justify-between">
                                                            ...
                                                            <span>{formatDate(selectedFacture.datePaiement)}</span>
                                                        </div>
                                                    )}
                                                    <div className="flex justify-between font-medium">
                                                        <span>Montant payé:</span>
                                                        <span>{selectedFacture.montantPaye.toLocaleString()} F</span>
                                                    </div>
                                                    {selectedFacture.resteAPayer > 0 && (
                                                        <div className="flex justify-between font-bold text-red-600">
                                                            <span>Reste à payer:</span>
                                                            <span>{selectedFacture.resteAPayer.toLocaleString()} F</span>
                                                        </div>
                                                    )}
                                                </div>
                                            ) : (
            ...
            {showSendModal && selectedFacture && (
                <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
                    <div className="bg-white rounded-lg shadow-lg max-w-md w-full">
                        <div className="p-6">
                            <div className="flex items-center justify-between mb-6">
                                <h3 className="font-bold text-gray-900">Envoyer la facture par email</h3>
                            ...
                            <div className="flex gap-3 mt-6">
                                <button
                                    onClick={() => {
                                        ...
                                        console.log('Envoi de la facture par email à:', selectedFacture.client.email);
                    ...
                    <div className="bg-white rounded-lg shadow-lg max-w-md w-full">
                        <div className="p-6">
                            ...
                            <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
                                <p className="font-medium text-red-900">Êtes-vous sûr de vouloir supprimer cette facture ?</p>
                                <p className="text-red-700 mt-1">{factureToDelete.numero}</p>
                                <p className="text-sm text-red-600 mt-2">Client: {factureToDelete.client.entreprise}</p>
                                <p className="text-sm text-red-600">Montant: {factureToDelete.totalAPayer.toLocaleString()} F</p>
                            </div>
            ...
            <footer className="mt-8 py-6 border-t bg-white">
                <div className="container mx-auto px-4">
                    <div className="text-center text-sm text-gray-600">
                        ...
                        <p className="mt-1">Montant total: {stats.montantTotal.toLocaleString()} F • Montant impayé: {stats.montantImpaye.toLocaleString()} F</p>
                    </div>
                </div>
            </footer>
        </div>
